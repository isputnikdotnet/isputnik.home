...
export function resetDb(): void {
  ...
  const tables = [
    "assignments", "access_settings", "invite_groups", "gallery_share_exclusions", "group_members", "shares", "share_links", "api_tokens", "inbox_delivery_seen", "gallery_music_tracks",
