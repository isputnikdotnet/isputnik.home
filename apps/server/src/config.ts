...
export const config = {
  ...
  // Fixture generated by `npm run seed:testing`; loaded from Control Panel → Maintenance.
  // Kept independent of DB_PATH so it always resolves to the repo's data/db/testing dir.
  testingDbPath: process.env.TESTING_DB_PATH ?? path.join(rootDir, "data", "db", "testing", "isputnik-testing.sqlite"),
