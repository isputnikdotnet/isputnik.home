...
| D12 | **No identity registry.** Records stay linked in pairs as today (tree member → face group → author). An **account → family-tree person** link comes later, with Q1, and never grants anything by itself. *Built 2026-09-24 (`user_family_person`): the chart opens on and badges "You", and the person's own record is never restricted for them.* | Agreed 2026-09-23 after reviewing the outside proposal: a registry table plus links from every record is a lot of machinery for a household. |
