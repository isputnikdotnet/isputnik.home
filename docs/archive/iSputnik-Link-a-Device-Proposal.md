...
Status: shipped in v3.5.0 (2026-08-14); kept for history. The living description is
[`auth.md`](../auth.md) and the [Link a device guide](../users/link-a-device.md); the
build is [`iSputnik-Link-a-Device-Plan.md`](iSputnik-Link-a-Device-Plan.md).
