...
Status: shipped in v3.5.0 (2026-08-14); kept for history. Linking from outside the
house followed in v3.6.0 —
[`iSputnik-Remote-Device-Linking-Plan.md`](../iSputnik-Remote-Device-Linking-Plan.md).
