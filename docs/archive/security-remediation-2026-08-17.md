...
Status: every P0–P3 item done and shipped in v3.10.0 (2026-08-17); kept for history.
The risks it accepted are listed in [SECURITY.md](../../SECURITY.md#accepted-risks).

Consolidates two independent security passes over isputnik.home:

- **Review A** — `docs/archive/security-review-2026-08-17.md` (API-surface + deployment review).
