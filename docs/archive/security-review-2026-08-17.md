...
Status: acted on in [`security-remediation-2026-08-17.md`](security-remediation-2026-08-17.md),
which shipped in v3.10.0 (2026-08-17); kept for history. The risks still accepted
are listed in [SECURITY.md](../../SECURITY.md#accepted-risks).
