...
Status: shipped in v3.26.0 (2026-08-25) — the five faces and three sizes, the closing
card with credits, multi-line opening text, the music fade and the clips — and revised
in v3.42.0 (2026-08-31), which moved the clip to after the closing card and retired the
opening clip; kept for history. How it works now is
